...
@section('main-content')
    ...
    <section class="container my-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <ul class="nav nav-pills nav-fill bg-light" id="loginTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="office-tab" data-toggle="tab" href="#office" role="tab"
                           aria-controls="office" aria-selected="true">Office Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="management-tab" data-toggle="tab" href="#management" role="tab"
                           aria-controls="management" aria-selected="false">Management Login</a>
                    </li>
                </ul>
                <div class="tab-content" id="loginTabContent">
                    ...
                    <div class="tab-pane fade" id="management" role="tabpanel" aria-labelledby="management-tab">
                        <div class="card">
                            <div class="card-header">Login to the management area...</div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('login-management') }}" aria-label="Login">
                                    @csrf
