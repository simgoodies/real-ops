...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="{{ route('tenants.office.index') }}" class="btn btn-danger btn-block">Return to office</a>
        </div>
        <div class="col-md-6">
            <a href="{{ route('tenants.office.events.create') }}" class="btn btn-success btn-block">Organize new event!</a>
        </div>
    </div>
    <div class="row">
